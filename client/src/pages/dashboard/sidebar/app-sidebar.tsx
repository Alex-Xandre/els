    ...
    <>
      <Sidebar collapsible="icon" {...props}>
        <nav className=" border-b  top-0 z-50 h-12 w-screen justify-between lg:inline-flex bg-blue-500 Z-50  fixed ">
          ...
          <p
            className={`absolute font-semibold top-3 ${
              open ? "left-64 ml-10" : "left-16 ml-2"
            }`}
          >
            {" "}
          </p>
          <p className="absolute left-12 top-3 text-base text-white">
            ELECTRONIC PRODUCTS ASSEMBLY AND SERVICING LEARNING MANAGEMENT
            APPLICATION
          </p>

          <p className="absolute right-2 top-3  text-white">EPAS LMA</p>
        </nav>
        <SidebarHeader>
